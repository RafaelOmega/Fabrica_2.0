...
from app.models.relatorio import FichaRelatorio
from app.utils.logger import get_logger

logger = get_logger("gerador_pdf")
...
def _secao_ficha(ficha: FichaRelatorio) -> list:
    barra = Table(
        [[Paragraph(
...
def gerar_pdf_fichas(fichas: list[FichaRelatorio], caminho: str,
                     periodo: str = "") -> str:
