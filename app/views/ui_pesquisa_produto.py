...
################################################################################
## Form generated from reading UI file 'pesquisa_produtoImKtwV.ui'
##
...
class Ui_Pesquisa_Prod(object):
    ...
    def retranslateUi(self, Pesquisa_Prod):
        Pesquisa_Prod.setWindowTitle(QCoreApplication.translate("Pesquisa_Prod", u"Pesquisa Produtos", None))
