...
class Ui_Ficha_Tecnica(object):
    def setupUi(self, Ficha_Tecnica):
        ...
        self.frm_Cadasro = QFrame(Ficha_Tecnica)
        self.frm_Cadasro.setObjectName(u"frm_Cadasro")
        self.frm_Cadasro.setFrameShape(QFrame.Shape.StyledPanel)
        self.frm_Cadasro.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout = QVBoxLayout(self.frm_Cadasro)
        self.verticalLayout.setSpacing(5)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(5, 5, 5, 5)
        self.frm_Ficha = QFrame(self.frm_Cadasro)
        ...
        self.frm_Cod_Acabado = QFrame(self.frm_Cadasro)
        ...
        self.frm_Cod_Materia_Prima = QFrame(self.frm_Cadasro)
        ...
        self.frm_Qtde = QFrame(self.frm_Cadasro)
        ...
        self.frm_Itens = QFrame(self.frm_Cadasro)
        ...
        self.frm_Total = QFrame(self.frm_Cadasro)
        ...
        self.frm_Crud = QFrame(self.frm_Cadasro)
        ...
        self.horizontalLayout.addWidget(self.frm_Cadasro)
